/*
  ...
  조건 1) 해당 월의 이용횟수가 없는 경우, 있는경우
  
  조건 2) 해당월의 이용횟수가 있는경우 (idx 1부터 시작할 경우 , idx 0부터면 -1 해줌)
          ㄱ. 1일 이용권 : 13월에 리턴, 비용--> 해당월 이용횟수 * 1일 요금
          ㄴ. 1달 이용권 : 13월에 리턴, 비용--> 1달 요금
          ㄷ. 3달 이용권 : 15월에 리턴(11,12월에도 3달이용권 사용할 수 있으므로, 12+3 = 15), 비용 --> 3달 요금
          
  조건 3) 1년 이용권을 최솟값으로 설정하고 계산함        
